...
<table width="384" height="404"  border="3" align="left" cellpadding="2">
  <tr>
    <td width="372" height="92"><table width="370" border="0" cellpadding="2">
      <tr>
        <td width="362" class="style7"><div align="center"><strong><span class="style5">SAVI DISTRIBUCIONES S.A DE C.V. </span></strong><a href="rc_modi.jsp?encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&clave1=&sur1=&sol1=&descrip1=&foliore=<%=folio_re2%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=&day5=&carnet=-&mes5=&aa5=&servicio=&encarser=&ban=<%=tipo_rec%>&usuario=<%=usuario%>" accesskey="Q">*</a></div></td>
      </tr>
      <tr>
