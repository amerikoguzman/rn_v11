      ...
      <table width="763" height="45" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td width="152" align="center" class="style2">
            FECHA:
            <input name="txtf_t1" class="style13" type="text" onKeyPress="return handleEnter(this, event)" onKeyUp="putDays()" value="<%=t1_jv%>" size="10" readonly/>
