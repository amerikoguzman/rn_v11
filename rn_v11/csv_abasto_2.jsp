...
conexion2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/abastos","root","eve9397");
...
out.print("Se realizó con EXITO la carga del ABASTO");
}// fin del else
//	} catch (Exception ex){mensaje=ex.toString();}


stmt.execute("insert into receta_carga_archivos values ('"+token+"','"+fecha_ins+"')");
}//fin del if archivo válido
else
{out.print("ERROR -9 Archivo Inválido, CONSULTE AL ADMINISTRADOR DEL SISTEMA");}
...
<body>
<br />
<a href="index.jsp">Regresar a Men&uacute;</a>
<%//=mensaje%>
</body>
<%
