...
int pos=0,tam2=0,x1=0,cont3=0,ban=0,posf=0,ban2=0,cant2_jv=0,cv_med2=0,cv_med3=0,cont1=0,cont5=0,cont6=0,sur2=0,sol2=0,mtotal=0,total2=0,total=0,flag=0,customerIds=0,cant_pasti_ampu=0,cant_surpas_amp=0,ttcant_surpas_amp=0,ttcant_surpas_amp2=0,ban_clave=0,tipo_rec=0,no_existe=0,surtida=0;
...
if(but.equals("Actualizar Datos"))
     {
		 ...
		 no_jur=request.getParameter("txtf_juris");
...
<form name="form" method="post" action="rc_modi3.jsp?usuario=<%=usuario%>&ban=<%=tipo_rec%>">
      ...
      <table width="914" height="61" border="0" align="center" cellpadding="2">
        <tr>
		 ...
		 %>
          ...
          <td width="291" class="style2">FECHA:<input name="txtf_date" type="text" class="Estilo5" onKeyPress="return handleEnter(this, event)" value="<%=date2_jv%>" size="10"/>&nbsp; HORA:
                <input name="reloj" type="text" value="<%=hora_jv%>"  class="Estilo5" onKeyPress="return handleEnter(this, event)" size="10" >         
            </td>
		...
		<table width="939" border="0" align="center" >
            <tr>
              ...
              <select name="select_servi"  class="style2" onChange="Servi_col(this.form)" onkeypress="return document.form.txtf_med1.focus();">
                ...
                <input type="text" name="txtf_servicio" class="Estilo5" size="30" value="<%=servicio_jv%>" />
              </span></td>
