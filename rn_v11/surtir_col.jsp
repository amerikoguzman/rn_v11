...
Función      : Archivo puente para recibir los valores de la receta colectiva anterior (PS), direcciona a 		   surtir_ins_col.jsp si se quiere surtir la receta, si no, regresa a receta_por_surtir.jsp
 ---------------------------------------------------------------------------------------------------- */
