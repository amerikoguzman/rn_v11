...
int sur1=0,resto=0,resto_jv=0,total3=0,present2=0,multi=0,total2=0,sur222=0,sur223=0,present22=0,altaOK=0;
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select servicio,clave,descrip,partida,cant_sol,cant_sur,fecha_re,folio_re,sum(cant_sur) from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"'  and tipo_receta='rc' group by (clave)");
	}
...
<table width="29%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_recol2a.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
			...
			<%
			  ...
			  clave= rset__001.getString("clave");
				...
				while(rset_date.next())
					...
					rset_1=stmt__001m.executeQuery("select servicio,clave,descrip,lote,caducidad,partida,cant_sol,cant_sur,fecha_re,folio_re,sum(cant_sur) from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"'  and clave ='"+clave+"' and tipo_receta='rc' and cant_sur!=0  group by (clave),servicio");
