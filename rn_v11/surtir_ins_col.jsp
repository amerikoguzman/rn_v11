...
<% 
/*----------------------------------------------------------------------------------------------------------------------
Nombre del Archivo: surtir_ins_col.jsp
Función : Realiza el surtimiento de un insumo dentro de una RC
------------------------------------------------------------------------------------------------------------------------*/
// Conexión a la BDD
...
String cb_jv="",nombre_jv="",edad_jv="",folio_jv="",cause_jv="",foliore_jv="",foliore2_jv="",radiopro_jv="",radiosur_jv="",date_jv="",reloj_jv="",encar_jv="",juris_jv="",clave_jv="",eliminar_jv="",usu_jv="",equipo_jv="",integrantes_jv="",recibe_id_jv="",t1_jv="",t2_jv="",t3_jv="",programa_jv="",lotes_jv="",cadus_jv="",id_inv="",afiliado_jv="",servicio_jv="",encarser_jv="";
//String eliminar_jv="";
	  ...
	  while(rset.next())
	  {
		...
		//fin rutina de update
		 // se agrega info a la tabla modificacion
				cant_x_sutir_neg*=-1;
				stmt1.execute("insert into modificacion values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+exis_restantes+"','"+rset.getString("origen")+"','"+cant_x_sutir_neg+"','"+exis_total_num+"','"+df.format(new java.util.Date())+"','"+encar_jv+"','SURTIENDO INSUMO','SURTIENDO INSUMO CON ESTATUS PENDIENTE POR SURTIR',current_timestamp,'"+foliore_jv+"','-','3','-','"+present1_jv+"','"+exis_total_num+"',0)");						 
					 // fin tabla modi 	
		if(resto==0)
		...
		stmt1.execute("update receta_colectiva set cant_sur='"+sur1_1_jv+"',surtido='"+status_surt+"',cant_pendi='"+resto+"',partida='"+rset.getString("origen")+"', status_receta='"+status+"',lote='"+rset.getString("lote")+"', caducidad='"+rset.getString("caducidad")+"', aux5='"+fechanew+"' where id='"+eliminar_jv+"'");	
		// fin update -------------------------
      ...
      */
		...
		//fin rutina de update
				...
				// se agrega info a la tabla modificacion
					  ...
					  stmt1.execute("insert into modificacion values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+exis_restantes+"','"+rset.getString("origen")+"','"+cant_x_sutir_neg+"','"+exist_may+"','"+df.format(new java.util.Date())+"','"+encar_jv+"','SURTIENDO INSUMO','SURTIENDO INSUMO CON ESTATUS PENDIENTE POR SURTIR',current_timestamp,'"+foliore_jv+"','-','3','-','"+present1_jv+"','"+exis_total_num+"',0)");						 
					 // fin tabla modi 	
				   sur1_1_jv=cant_x_sutir;
   ...
   while(rset.next())
	  {
		...
		// se agrega info a la tabla modificacion
		 ...
		 stmt1.execute("insert into modificacion values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+exis_may+"','"+rset.getString("origen")+"','"+cant_x_sutir_neg+"','0','"+df.format(new java.util.Date())+"','"+encar_jv+"','SURTIENDO INSUMO','SURTIENDO INSUMO CON ESTATUS PENDIENTE POR SURTIR',current_timestamp,'"+foliore_jv+"','-','3','-','"+present1_jv+"','0',0)");						 
					 // fin tabla modi 
		...
		sexo_jv=indica2_jv;
		reloj_jv=clave2_jv;
		stmt1.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+fechanew+"','"+hora_com+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','"+nombre_jv+"','"+edad_jv+"','"+folio_jv+"','"+programa_jv+"','-','"+cedu_jv+"','"+nomed_jv+"','"+cause_jv+"','"+clave1_jv+"','"+descrip1_jv+"','"+exis_may+"','"+exis_may+"','"+status_surt+"','"+encar_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+rset.getString("origen")+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','-','-','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+carnet_jv+"','"+servicio_jv+"','"+fechanew+"','A','"+sexo_jv+"','"+indica3_jv+"','-','-','-','-','-','"+corte+"','"+ampuleo+"',0)");	
		// fin insert
		  ban_sp=1;
...
//out.print("hace el update");
		stmt1.execute("update receta_colectiva set cant_sol='"+pen_sur+"',surtido='"+status_surt+"',cant_pendi='"+pen_sur+"',status_receta='"+status+"', aux5='"+fechanew+"' where id='"+eliminar_jv+"'");	
		// fin update -------------------------
