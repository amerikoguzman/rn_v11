...
int sol1=0,sur1=0,sol11=0,sur11=0,present2=0,multi=0,total2=0,total3=0,resto=0,sur222=0,present22=0,resto_jv=0, ban_entro=0;
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,lote,caducidad,sum(cant_sol),sum(cant_sur),present from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"'  and tipo_receta='rc' and cant_sur!=0 group by (clave),lote,caducidad order by (clave+0)");
...
<table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#CCFF99">
  	<td height="25" colspan="7" bgcolor="#CF1345" id="dateformat">&nbsp;&nbsp;<span class="style76">
  	  <script language="JavaScript" type="text/javascript">
      //document.write(TODAY);	</script>
      <a href="reportes_val_rc.jsp" class="style76"><span class="Estilo1">Regresar a Menú</span></a></span>&nbsp;
      <!--img src="icono_excel.gif" border="0" usemap="#Map2"/-->&nbsp;&nbsp;&nbsp;<span class="Estilo1">&nbsp;&nbsp;EXPORTAR&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="imagenes/exc.jpg" width="37" height="29" border="0" usemap="#Map2"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo1">ORIGEN&nbsp;"<%=dest%>"</span></td>
  </tr>
 <tr>
    <td colspan="7" bgcolor="#003366"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
    ...
    <table width="434" border="0" align="center">
      <tr>
        <td width="418"><table width="1145" border="1">
            <tr>
              
              <td width="124"> <span class="Estilo13">Clave</span></td>
              <td width="468"> <div align="center"><span class="Estilo13">Descripci&oacute;n</span></div></td>
              
              
              <td width="246"><div align="center"><span class="Estilo13">UM </span></div></td>
              <td width="279"><div align="center"><span class="Estilo13">Lote</span></div></td>
              <td width="279"><div align="center"><span class="Estilo13">Caducidad</span></div></td>
             
              <td width="279"><div align="center"><span class="Estilo13">Total Cajas </span></div></td>
    ...
    while(rset__001.next()) 
				  ...
				  Connection conn = 
                  DriverManager.getConnection("jdbc:mysql://localhost/r_n");
	...
	%>
            ...
            <tr>
              ...
              <td colspan="9"><div align="right" class="Estilo3">ADMINISTRADOR&nbsp;DE LA UNIDAD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ENCARGADO(A) DE LA FARMACIA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FILTRO DE LA SECRETARIA DE SALUD DE NAYARIT</div></td>
              </tr>
