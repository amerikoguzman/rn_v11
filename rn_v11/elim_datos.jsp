...
<% 
/* ----------------------------------------------------------------------------------------------------
Nombre de JSP: elim_datos.jsp
Función      : Elimina Folio de la RF
 ---------------------------------------------------------------------------------------------------- */
...
if(but.equals("Eliminar Folio"))
	...
	if(cont4>0) 
	{
		stmt2.execute("insert into receta_elim(SELECT * from receta where folio_re='"+act_folio+"'); "); 
		stmt2.execute("delete FROM receta where folio_re='"+act_folio+"' ");   
		%>
        <script>
...
<form name="form" method="post" action="elim_datos.jsp?uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&part=<%=part_jv%>&carnet=<%=carnet_jv%>&usuario=<%=usuario%>">
      ...
      <table width="877" height="59" border="0" align="center" cellpadding="2">
        <tr>
		 ...
		 %>
          ...
          <td width="250" align="center" class="style2">
            FECHA:
                  <input name="txtf_t1" type="text" class="style13" id='txtf_t1' onKeyPress="return handleEnter(this, event)"  value="<%=t1_jv%>" size="10" readonly/>&nbsp;&nbsp;
          </td>
        </tr>
    </table>    </td>
  </tr>
        ...
        <tr>
          <td height="41" colspan="3" class="style4"><table width="874" border="0" align="center" cellpadding="2">
            <tr>
              <td width="685" class="style2">FOLIO:<input name="txtf_f" type="text" class="style13"  onKeyPress="return handleEnter(this, event)"  value="<%=foliore_jv%>" size="10" readonly colspan="3"/>&nbsp;&nbsp;UNIDAD DE SALUD
              <input type="text" name="txtf_unidadmed" size="55" colspan="3" class="style13"  value="<%=nom_unidad%>" readonly onKeyPress="return handleEnter(this, event)"/></td>
          ...
          <td height="62" colspan="3" class="style4"><table width="859" border="0" align="center" cellpadding="2">
            <tr>
              <td width="724" height="52" class="style2">NOMBRE DEL PACIENTE:
                ...
                <span class="style5">
                <label> </label>
                <input name="txtf_paciente" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=nombre_jv%>" size="55" readonly/>
                </span>
                ...
                <input name="txtf_carnet" type="text" class="style13" value="<%//=carnet_jv%>" size="8"  onKeyPress="return handleEnter(this, event)"/-->
                 Sexo:
                <input name="txtf_sexo" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=sexo_jv%>" size="5" readonly/>
                EDAD:
                <input name="txtf_edad" type="text" class="style13"  onkeypress="return handleEnter(this, event)" value="<%=edad_jv%>" size="5" readonly/>
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE</span><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO PATERNO &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO MATERNO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label></td>
            ...
            <tr>
              ...
              <input name="txtf_cedu" type="text" class="style13" id="a"  onKeyPress="return handleEnter(this, event)" value="<%=cedu_jv%>" size="10" readonly/> <!--input name="txtf_id" type="text" class="style13" value="<%//=id_rec%>" size="5"  onkeypress="return handleEnter(this, event)" readonly="readonly"/-->
              </span>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
    ...
    <tr class="letras">
        ...
        <tr>
          <td height="25" colspan="3" align="center">
            <!--input name="Eliminar Folio" type="button" class="subHeader" value="Eliminar Folio" onClick="javascript:document.location.href='elim_folio.jsp?folio=<%=foliore_jv%>';"/-->
          <a onClick="return confirm('Seguro que desea eliminarlo?')" href="elim_folio.jsp?usuario=<%=usuario%>&folio=<%=foliore_jv%>&url=<%=request.getRequestURL() %>">Eliminar Folio</a></td>
  </tr>
        </tr>
        <tr>
