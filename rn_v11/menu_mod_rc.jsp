...
<table width="666" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="650"><form id="form" name="form" method="post" action="menu_mod_rc.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1"><div align="center">Modificar Recetas Colectiva</div></td>
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="rc_elim.jsp?usuario=<%=am22_jv%>">ELIMINAR FOLIO DE LA RECETA COLECTIVA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="3" class="style5"><label><a href="rc_modi.jsp?usuario=<%=am22_jv%>">MODIFICAR DATOS DE LA RECETA COLECTIVA (ENCABEZADO)</a></label></td>
          </tr>
        <tr>
          <td height="20"><div align="right">
            <div align="left" class="Estilo6"></div>
          </div></td>
          <td colspan="3" class="style5"><label><a href="rc_modi2.jsp?usuario=<%=am22_jv%>">REINTEGRAR INSUMO AL INVENTARIO / ERROR DE CAPTURA / AGREGAR INSUMO</a> </label></td>
          </tr>
        <tr>
          <td height="20">&nbsp;</td>
          <td colspan="2" class="style5"><!--label><a href="modi3_receta.jsp?uni=&juris=&nombre=&edad=&folio=&foliore=&nomed=&day5=&cedu=&ban=1&aa5=&mes5=<%=am22_jv%>&clave1=&descrip1=&sol1=&cause=">AGREGAR/ ELIMINAR CLAVE A LA RECETA</a> </label--></td>
          <td>&nbsp;</td>
        </tr>
      </table>
          </form>
