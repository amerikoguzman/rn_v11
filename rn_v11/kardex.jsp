...
int existe=0,am2_jv=0,exist=0,ap2_jv=0,total=0,pos=0,encontrado=0,encontrado_ing=0,exist_inv=0,ing_from_inv=0,sal_from_inv=0,exist_new=0,exist_ant=0,sum_mov_ent=0,sum_mov_sal=0,sum_total_exis=0,ban_ciclos=0,ban_ciclos_sali=0;
...
<table width="952" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="650"><form id="form" name="form" method="post" action="kardex.jsp?usuario=<%=am22_jv%>">
      <table width="856" height="344" border="0" align="center" cellpadding="2">
        ...
        <tr>
          <td width="145" height="20"><span class="Estilo6">Seleccione Origen  :</span></td>
          <td colspan="2" class="bodyText"><span class="Estilo6"><span class="style5">
          ...
          <td width="125"><span class="Estilo6">Origen: <span class="style5">
        ...
        <tr>
          ...
          <td colspan="3" class="style5"><input name="txtf_lote" type="text" id="txtf_lote" onChange="mayApemm(this.form)" onKeyPress="return handleEnter(this, event)" value="<%=lote_jv%>" size="10" />
            <%
		   if(pos>=1)
		   {
		%>
	...
	%>
      ...
      <%
        ...
        <tr>
          <td height="20"><div align="right">
            <div align="left">MOVIMIENTOS ENTRADAS:</div>
          </div></td>
          <td width="126" class="style5">MOVIMIENTOS SALIDAS:</td>
          <td width="265" class="style5">&nbsp;</td>
          <td class="style5">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><%=sum_mov_ent%></td>
        ...
        <tr>
          <td height="20">ENTRADAS</td>
          <td class="style5">SALIDAS</td>
          <td class="style5">&nbsp;</td>
          <td class="style5">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
       <tr>
		...
		{   
		 while(rset_001.next())
			 {// 
	    %>
              <tr><td><%=rset_001.getString("cant")%></td></tr>
        <%
			}
		}
		%>
	 ...
	 if(ban_ciclos_sali==1)
		...
		while(rset_002.next())
			 {// 
	    %>
              <tr><td><%=rset_002.getString("cant")%></td></tr>
        <%
			}
		}
		%>
        ...
        <tr>
          ...
          <td class="style5"><%=sum_mov_ent%></td>
          <td class="style5">&nbsp;</td>
          <td class="style5">&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
