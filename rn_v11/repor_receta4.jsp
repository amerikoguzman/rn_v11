...
conn__001 = DriverManager.getConnection("jdbc:mysql://localhost:3306/r_nayarit","root","eve9397");
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,lote,caducidad,sum(cant_sur),present from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+origen_jv+"' and tipo_receta='rc' and cant_sur!=0 group by (clave),lote,caducidad order by clave asc; ");
	}
...
<table width="1320" cellpadding="3" cellspacing="1" border="0" >
  <tr height="20">
    <td height="20" colspan="15"  align="center"><p align="center">GOBIERNO DEL ESTADO DE NAYARIT</p>
      <p align="center">SECRETARIA DE SALUD</p>
      <p align="center">SAVI DISTRIBUCIONES  S.A DE C.V.</p>
      <p align="center">REPORTE DETALLADO DE CONSUMO POR RECETA COLECTIVA </p>
  ...
  <tr height="20">
    <td width="132" height="20" style="border:double"><div align="center">CLAVE ARTICULO </div></td>
    <td height="20" colspan="5" style="border:double"><div align="center">DESCRIPCI&Oacute;N</div></td>
    <td width="336" style="border:double"><div align="center">UM</div></td>
    <td width="102" style="border:double"><div align="center">LOTE</div></td>
    <td width="102" style="border:double"><div align="center">CADUCIDAD</div></td>
    
    <td width="102" style="border:double"><div align="center">TOTAL CAJAS</div></td>
  ...
  <%
   present="1";
    while(rset__001.next()) 
				  ...
				  Connection conn = 
                  DriverManager.getConnection("jdbc:mysql://localhost:3306/r_nayarit","root","eve9397");
  ...
  <tr height="20" >
    ...
    <td style="border:double"><%=rset__001.getString("lote")%></td>
    <td style="border:double"><%=rset__001.getString("caducidad")%></td>
