...
//var cad1="Acura";
        ...
        addOption(document.form.SubCat, "LA CONCEPCI�N II (ATLACOMULCO)", "LA CONCEPCI�N II (ATLACOMULCO)")
...
//var cad1="Acura";
        ...
        addOption(document.form.SubCat, "CASA DE SALUD LA CONCEPCION DE LOS BA�OS III  ** IXT - IXT *", "CASA DE SALUD LA CONCEPCION DE LOS BA�OS III  ** IXT - IXT *")
        addOption(document.form.SubCat, "SAN PEDRO DE LOS BA�OS I ( IXTLAHUACA )", "SAN PEDRO DE LOS BA�OS I ( IXTLAHUACA )")
        addOption(document.form.SubCat, "C.S. CONCEPCION LOS BA�OS (1) IXT - IXTLAHUACA", "C.S. CONCEPCION LOS BA�OS (1) IXT - IXTLAHUACA")
        addOption(document.form.SubCat, "C.S. CONCEPCION LOS BA�OS (2) IXT - IXTLAHUACA", "C.S. CONCEPCION LOS BA�OS (2) IXT - IXTLAHUACA")
        addOption(document.form.SubCat, "C.S. CONCEPCION LOS BA�OS (3) IXT-IXTLAHUACA", "C.S. CONCEPCION LOS BA�OS (3) IXT-IXTLAHUACA")
        addOption(document.form.SubCat, "C.S. CONCEPCION LOS BA�OS (4) IXT - IXTLAHUACA", "C.S. CONCEPCION LOS BA�OS (4) IXT - IXTLAHUACA")
        ...
        addOption(document.form.SubCat, "C.S. JALPA DE LOS BA�OS ++ IXT - IXTLAHUACA ++", "C.S. JALPA DE LOS BA�OS ++ IXT - IXTLAHUACA ++")
        ...
        addOption(document.form.SubCat, "SAN CRISTOBAL DE LOS BA�OS(1) (IXTLAHUACA)", "SAN CRISTOBAL DE LOS BA�OS(1) (IXTLAHUACA)")
        addOption(document.form.SubCat, "SAN CRISTOBAL DE LOS BA�OS(2) (IXTLAHUACA)", "SAN CRISTOBAL DE LOS BA�OS(2) (IXTLAHUACA)")
        ...
        addOption(document.form.SubCat, "C.S. SAN PEDRO DE LOS BA�OS II (1)  IXT - IXTLAHUACA", "C.S. SAN PEDRO DE LOS BA�OS II (1)  IXT - IXTLAHUACA")
        addOption(document.form.SubCat, "C.S. SAN PEDRO DE LOS BA�OS II (2)  IXT - IXTLAHUACA", "C.S. SAN PEDRO DE LOS BA�OS II (2)  IXT - IXTLAHUACA")
        addOption(document.form.SubCat, "C.S. SAN PEDRO DE LOS BA�OS II - ODONTOLOGICO *IXT-IXT*", "C.S. SAN PEDRO DE LOS BA�OS II - ODONTOLOGICO *IXT-IXT*")
        ...
        addOption(document.form.SubCat, "SAN PEDRO DE LOS BA�OS III CASA BLANCA  (IXTLAHUACA)", "SAN PEDRO DE LOS BA�OS III CASA BLANCA  (IXTLAHUACA)")
        ...
        addOption(document.form.SubCat, "CONCEPCI�N DEL MONTE (1) (IXTLAHUACA)", "CONCEPCI�N DEL MONTE (1) (IXTLAHUACA)")
...
//var cad1="Acura";
        ...
        addOption(document.form.SubCat, "CASA DE SALUD BA�E (JILOTEPEC)", "CASA DE SALUD BA�E (JILOTEPEC)")
        ...
        addOption(document.form.SubCat, "MONTE DE PE�A ( JILOTEPEC )", "MONTE DE PE�A ( JILOTEPEC )")
...
//var cad1="Acura";
        ...
        addOption(document.form.SubCat, "CA�ADAS DE NANCHITITLA  ( TEJUPILCO )", "CA�ADAS DE NANCHITITLA  ( TEJUPILCO )")
...
//var cad1="Acura";
        ...
        addOption(document.form.SubCat, "CASA DE SALUD CIENEGUILLAS DE MA�ONES ( TOLUCA)", "CASA DE SALUD CIENEGUILLAS DE MA�ONES ( TOLUCA)")
        ...
        addOption(document.form.SubCat, "C.S.R.  SALITRE DE MA�ONES  PROGRESA **TOL - ALM. DE JUAREZ*", "C.S.R.  SALITRE DE MA�ONES  PROGRESA **TOL - ALM. DE JUAREZ*")
        ...
        addOption(document.form.SubCat, "CASA DE SALUD CA�ADA DE GUADARRAMA ( TOLUCA)", "CASA DE SALUD CA�ADA DE GUADARRAMA ( TOLUCA)")
...
//
        ...
        addOption(document.form.SubCat, "CASA DE SALUD MAYORAZGO DE LE�N 2 (TOLUCA)", "CASA DE SALUD MAYORAZGO DE LE�N 2 (TOLUCA)")
...
function ValidateFar1(form) {
    ...
    //return true;
    if (prov.value == "") {
        alert('El PROVEEDOR es un dato necesario, ingresalo por favor');
        form.txtf_4.focus();
        //return false;
    }//return true;
    if (recibe.value == "") {
        alert('Quien RECIBE es un dato necesario, ingresalo por favor');
        form.txtf_5.focus();
        //return false;
    }//return true;
    if (entrega.value == "") {
        alert('Quien ENTREGA es un dato necesario, ingresalo por favor');
        form.txtf_8.focus();
        //return false;
    }//return true;
    if (ubicacion.value == "") {
        alert('La UBICACION es un dato necesario, ingresalo por favor');
        form.txtf_6.focus();
        //return false;
    }//return true;
    if (origen.value == "") {
        alert('El ORIGEN es un dato necesario, ingresalo por favor');
        form.txtf_7.focus();
        //return false;
    }//return true;
    if (coincide.value == "") {
        alert('Debes indicar SI o NO Coincide el Documento con la Remisi�n');
        form.txtf_coin.focus();
        return false;
    }
    return true;
...
function ValidateCat(form) {
    ...
    {
        alert('Error, Debe ingresar el NOMBRE DE QUIEN LLAMO');
        form.txtf_nom.focus();
        //alert(""+idd.value)
        //return false; 
    }
    //return true;
    if (asunto.value == "") {
        alert('El ASUNTO es un dato necesario, ingresalo por favor');
        form.txtf_asun.focus();
        //return false;
    }//return true;
    if (tel1.value == "") {
        alert('El FORMATO DEL NUMERO TELEFONICO ES INCORRECTO, Ingres�lo nuevamente');
        form.txtf_6.focus();
        //return false;
    }//return true;
    else if (tel2.value == "") {
    ...
    if (recado.value == "") {
        alert('Debes ingresar un RECADO para ubicar la llamada');
        form.txtf_rec.focus();
        //return false;
    }//return true;
    if (oper.value == "") {
        alert('Debes registrar el OPERADOR que recibio la LLAMADA');
        form.txtf_toma.focus();
        return false;
    }
    return true;
...
function ValidateLlamSal(form) {
    ...
    if (nom.value == "")  //IsEmpty(form.usuario)
    {
        alert('Error, Debe ingresar el NOMBRE DE LA PERSONA A LLAMAR');
        form.txtf_nom.focus();
        //alert(""+idd.value)
        return false;
    }
    //return true;
    if (mot.value == "") {
        alert('El MOTIVO es un dato necesario, ingresalo por favor');
        form.txtf_mot.focus();
        return false;
    }//return true;
    if (fecha.value == "") {
        alert('Ingresa la FECHA DE LA PROXIMA VISITA por favor');
        form.txtf_caduc.focus();
        return false;
    }
    if (juris.value == "") {
        alert('LA JURISDICCI�N es un dato necesario, ingresalo por favor');
        form.txtf_jur.focus();
        return false;
    }//return true;
    else if (usu.value == "") {
        alert('Error, Debe ingresar el NOMBRE DE LA PERSONA QUE REGISTRO LA LLAMADA');
        form.txtf_usu.focus();
        return false;
    }
    return true;
...
function showHideItems(myItem, glo) {
    ...
    var myItem = document.getElementById(myItem);
    if (myItem.style.display != "none") {//alert("if no"+myItem.id);
...
function fillCategoryTol() {
    ...
    addOption(document.form.slect_cat, "B.I.", "Batall�n de Infanter�a");
...
function putUbic2(form) {//alert("siiiii");
...
function setClienteDess(form) {//alert("entro");
    var clides = form.slct_des.value;
    //alert("entro"+clides);
...
function putUbi_en(form) {//alert("siiiii");
...
function isChar(Data) {
    varChars = "������o��'-abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    var isChar = true;
    var index = 0;
    ...
    if (!isChar) {
        window.alert("Erreur ! Saisissez une chaine de caract�res");
...
//addOption(document.form.SubCat, "", "No. de Cuenta", "");     
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA I DURANGO') {
        //addOption(document.form.SubCat,"","--Escoja Pelot�n--")
        ...
        addOption(document.form.SubCat, "ALMAC�N GENERAL", "ALMAC�N GENERAL")
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA II GOMEZ PALACIO') {
        ...
        addOption(document.form.SubCat, "HOSPITAL INTEGRAL DE PE�ON BLANCO", "HOSPITAL INTEGRAL DE PE�ON BLANCO")
        addOption(document.form.SubCat, "ALMAC�N JURISDICCI�N SANITARIA NO. 2", "ALMAC�N JURISDICCI�N SANITARIA NO. 2")
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA III SANTIAGO PAPASQUIARO') {
        ...
        addOption(document.form.SubCat, "ALMAC�N JURISDICCI�N SANITARIA NO. 3", "ALMAC�N JURISDICCI�N SANITARIA NO. 3")
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA IV RODEO') {
        ...
        addOption(document.form.SubCat, "ALMAC�N JURISDICCI�N SANITARIA NO.4 RODEO", "ALMAC�N JURISDICCI�N SANITARIA NO.4 RODEO")
...
//addOption(document.form.SubCat, "", "No. de Cuenta", "");     
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA I DURANGO') {
        ...
        addOption(document.form.SubCat, "CENTRO ESTATAL DE CANCEROLOG�A", "CENTRO ESTATAL DE CANCEROLOG�A")
        ...
        addOption(document.form.SubCat, "CS SANTA MAR�A DE OCOTAN", "CS SANTA MAR�A DE OCOTAN")
    ...
    if (document.form.Category.value == 'JURISDICCION SANITARIA II GOMEZ PALACIO') {
        ...
        addOption(document.form.SubCat, "CENTRO DE SALUD DE G�MEZ PALACIO", "CENTRO DE SALUD DE G�MEZ PALACIO")
...
function verificaN_Fa3(obj) {
    fecha_hoy = new Date();
    ahora_anio = fecha_hoy.getYear();
    ahora_mes = fecha_hoy.getMonth() + 1;
    ahora_dia = fecha_hoy.getDate();
    dia_receta = obj.txtf_t1.value;
    mes_receta = obj.txtf_t2.value;

    if (dia_receta > ahora_dia && mes_receta >= ahora_mes) {
        alert("Fecha invalida, Introduzca una FECHA IGUAL O MENOR AL DIA DE HOY");
        return false;
    }
...
function verificaN_Fa22(obj) {
    ...
    //alert("dia"+ahora_dia+"mes"+ahora_mes);

    if ((dia_receta >= 1 || dia_receta <= 31) && mes_receta > ahora_mes) {
        alert("Fecha invilida,Introduzca una FECHA IGUAL O MENOR AL DIA DE HOY");
        return false;
    }
    if (obj.txtf_t1.value == "") {
        missinginfo += "\n - Campo DIA";
...
function verifica_PSI(obj) {
    missinginfo = "";
    if (obj.txtf_paciente.value == "") {
        missinginfo += "\n - Campo Nombre del Beneficiario se encuentra vac�o";
    }

    if (missinginfo != "") {
        missinginfo = "NO SE HA INGRESADO UN FOLIO V�LIDO:\n" + missinginfo + "\n\n �INGRESA UN FOLIO Y TRATA OTRA VEZ!\n";
        alert(missinginfo);
...
// funci�n validar RC PS Imprimir
function verifica_PSI2(obj) {
    missinginfo = "";
    if (obj.txtf_servicio.value == "") {
        missinginfo += "\n - Campo Servicio se encuentra vac�o";
    }
...
//funci�n pta validar RC vac�os
function verifica_RC(obj) {
    missinginfo = "";
    fecha_hoy = new Date();
    ahora_anio = fecha_hoy.getYear();
    ahora_mes = fecha_hoy.getMonth() + 1;
    ...
    if (dia_receta > ahora_dia || mes_receta > ahora_mes) {
        alert("Fecha inv�lida,Introduzca una FECHA IGUAL O MENOR AL D�A DE HOY");
        return false;
    }
    if (obj.txtf_servicio.value == "") {
        missinginfo += "\n - Campo Servicio";
...
//funci�n pta validar RCI vac�os
function verifica_RCI(obj) {
    missinginfo = "";
    if (obj.txtf_servicio.value == "") {
        missinginfo += "\n - Campo Servicio";
    }
...
function verifica_ING(obj) {
    missinginfo = "";
    if (obj.txtf_clave2.value == "") {
        missinginfo += "\n - Campo CLAVE";
    }
    if (obj.txtf_lote.value == "") {
        missinginfo += "\n - Campo LOTE";
    }
    if (obj.txtf_cad.value == "") {
        missinginfo += "\n - Campo CADUCIDAD";
    }
    if (obj.txtf_origen.value == "") {
        missinginfo += "\n - Campo ORIGEN";
    }
    if (obj.txtf_exist.value == "") {
        missinginfo += "\n - Campo EXISTENCIA";
    }
    if (obj.txtf_cant.value == "0" || obj.txtf_cant.value == "") {
        missinginfo += "\n - Campo CANTIDAD";
    }
    if (obj.txta_razon.value == "") {
        missinginfo += "\n - Campo RAZ�N DE AJUSTE";
    }
...
// fin fucnci�
function verifica_ACT(obj) {
    missinginfo = "";
    if (obj.txtf_f.value == "") {
        missinginfo += "\n - Campo FOLIO";
    }
    if (obj.txtf_unidadmed.value == "") {
        missinginfo += "\n - Campo UNIDAD";
    }
    if (obj.txtf_njuris.value == "") {
        missinginfo += "\n - Campo JURIS";
    }
    if (obj.txtf_paciente.value == "") {
        missinginfo += "\n - Campo PACIENTE";
    }
    if (obj.txtf_sexo.value == "") {
        missinginfo += "\n - Campo G�NERO";
    }
    if (obj.txtf_edad.value == "0") {
        missinginfo += "\n - Campo EDAD";
    }
    if (obj.txtf_foliosp.value == "") {
        missinginfo += "\n - Campo FOLIO SP";
...
function putFolio2() {
    var folio = document.form.slct_fol.value
    document.form.txtf_foliore2.value = folio;
}
function putFolio() {
    var folio = document.form.slct_fol.value
    document.form.txtf_foliore.value = folio;
}
function imprime() {//alert("Ingreso");
    document.form.txtf_ruta.value = document.form.slct_ruta.value;
}
function copiarContenido() {

    var num1 = document.getElementById('datasize').value;
    document.getElementById('txtf_ruta').value = num1;
}
...
function putYearss(form) {
    ...
    if (year == 5) {
        ...
        //alert(""+day+" "+d.getDate());
        if ((yearv <= 2013 || yearv > 2013) || (day < d.getDate() && month <= (d.getMonth() + 1) && yearv <= 2011)) {

            if ((yearv <= 2013 || yearv > 2013)) {
                alert("A�o Fuera de Rango: " + yearv);
                document.form.txtf_t3.value = "";
                document.form.txtf_t3.focus();
            }
            if ((day < d.getDate() && month <= (d.getMonth() + 1) && yearv <= 2012)) {
...
function maySexo(form) {
    document.form.txtf_sexo.value = document.form.txtf_sexo.value.toUpperCase();
}
function mayPaciente(form) {
    document.form.txtf_paciente.value = document.form.txtf_paciente.value.toUpperCase();
}
...
function mayeE(form) {
    document.form.txtf_encarser.value = document.form.txtf_encarser.value.toUpperCase();
}
function Servi_col(form) {//alert("siiiii");
    var servi = form.select_servi.value
    form.txtf_servicio.value = servi;
    form.txtf_encarser.focus();
}
...
function calculaEdad(form) {
    var dia = parseInt(document.form.txtf_t1a);
    var mes = parseInt(document.form.txtf_t2a);
    var anios = parseInt(document.form.txtf_t3a);
}
function test1000() {
    alert("hola");
}
