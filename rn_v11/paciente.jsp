...
if (but!=null){
        ...
        stmt.execute("insert into pacientes values ('"+nombre+"', '"+fec_nac+"', '"+request.getParameter("slct_sexo")+"', '"+request.getParameter("txtf_noaf")+"', '"+request.getParameter("programa")+"', '"+ini_vig+"', '"+fin_vig+"')");
        }
}
// ---------------------
%>
                                ...
                                <td colspan="2"><div align="left">
										...
										if (but!=null){
                                                    if(but.equals("Guardar")){
                                                            ...
                                                            out.print("No de Afiliación: "+request.getParameter("txtf_noaf"));
