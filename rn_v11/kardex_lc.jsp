...
// Proceso Mostrar
    if (but.equals("Mostrar")) {// inicio de if
        ban_ciclos = 0;
        ...
        rset_001 = stmt01.executeQuery("select sum(cant) as total_exis from movimientos_entradas where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';");
        //out.print("select sum(cant) as total_exis from movimientos_entradas where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';<br>");

        while (rset_001.next()) {// inicio while 1
            ban_ciclos = 1;
            sum_mov_ent = Integer.parseInt(rset_001.getString("total_exis"));
        }// fin while 1
        rset_001 = stmt01.executeQuery("select sum(cant) as total_exis from movimientos_salidas where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';");
        //out.print("select sum(cant) as total_exis from movimientos_salidas where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';<br>");

        while (rset_001.next()) {// inicio while
        ...
        if (ban_ciclos == 1) {
            rset_001 = stmt01.executeQuery("select cant from movimientos_entradas where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';");
            //out.print("select sum(cant) as total_exis from movimientos_salidas where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';<br>");
        }
        if (ban_ciclos_sali == 1) {
            rset_002 = stmt.executeQuery("select cant from movimientos_salidas where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';");
            //out.print("select sum(cant) as total_exis from movimientos_salidas where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';<br>");
            //ban_ciclos=1;
        }

        // Para mostrar modificaciones
        rset_mod = stmt_mod.executeQuery("select folio,cant_anterior,cant_mov,cant_actual,status,obser,origen,usuario,fecha,hora from modificacion where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';	 ");
        //out.print("select folio,cant_anterior,cant_mov,cant_actual,status,obser,origen,usuario,fecha,hora from modificacion where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';	<br> ");
//select sum(cant) as total_exis from movimientos_entradas where clave='"+clave_jv+"' and lote='"+lote_jv+"' and caducidad='"+cad_jv+"' and origen='"+origen_jv+"';
        ...
        if (rset_mod.next()) {// inicio while 1
            ban_mod = 1;
...
<%
    ...
    if (origen2.equals("--Origen--")) {// inicio de if origen2
%>
<script>
...
<table width="952" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
    <tr>
        ...
        <td width="650">
            <form id="form" name="form" method="post" action="kardex_lc.jsp?usuario=<%=am22_jv%>">
                <table width="856" height="344" border="0" align="center" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="bodyText"><span class="Estilo6"><span class="style5">
                                            <select name="slct_origen" class="Estilo6"
                                            ...
                                            <input name="txtf_origen" type="text" id="txtf_origen"
                                                   onChange="mayApemm(this.form)"
                                                   onKeyPress="return handleEnter(this, event)" value="<%=origen_jv%>"
                                                   size="10"/>
                                        </span></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="style5"><span class="Estilo6">
                                        <input name="txtf_clave2" type="text" id="txtf_clave2"
                                               onChange="mayNomm(this.form)"
                                               onKeyPress="return handleEnter(this, event)" value="<%=clave_jv%>"
                                               size="10" readonly/>
                                        Descripci&oacute;n:</span><span class="Estilo6">
                                        <textarea name="txtf_descrip" cols="50" id="txtf_descrip"
                                                  onChange="mayApepm(this.form)"
                                                  onKeyPress="return handleEnter(this, event)" readonly><%=descrip_jv%>
                                        </textarea>
                                    </span>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="style5"><input name="txtf_lote" type="text" id="txtf_lote"
                                                              onChange="mayApemm(this.form)"
                                                              onKeyPress="return handleEnter(this, event)"
                                                              value="<%=lote_jv%>" size="10"/>
                            <%
                                if (pos >= 1) {
                            %>
                ...
                dimePropiedades(this.form);" onkeypress="return handleEnter(this, event)">
                                ...
                                %>
                                <option value="<%=lotes[x1]%>"><%=lotes[x1]%>
                                </option>
                                <%
                                    }
                                %>
                            ...
                            %>
                                    ...
                                    <span class="Estilo6">Caducidad: 
                                        <input name="txtf_cad" type="text" id="txtf_cad" onChange="mayApemm(this.form)"
                                               onKeyPress="return handleEnter(this, event)" value="<%=cad_jv%>"
                                               size="10"/>
                                        <%
                                            if (pos >= 1) {
                                        %>
                        ...
                        <td height="20" colspan="10">
                            <table width="97%" border="0" cellpadding="0" cellspacing="0" id="dataTable">
                                ...
                                <%
                                    if (ban_mod == 1) {
                                        // Para mostrar modificaciones
                                        rset_mod2 = stmt_mod2.executeQuery("select folio,cant_anterior,cant_mov,cant_actual,present,total_cajas,status,obser,origen,usuario,fecha,hora from modificacion where clave='" + clave_jv + "' and lote like '%" + lote_jv + "%' and caducidad like '%" + cad_jv + "%' and origen like '%" + origen_jv + "%';	 ");
                                        //out.print( "select folio,cant_anterior,cant_mov,cant_actual,present,total_cajas,status,obser,origen,usuario,fecha,hora from modificacion where clave='"+clave_jv+"' and lote like '%"+lote_jv+"%' and caducidad like '%"+cad_jv+"%' and origen='"+origen_jv+"';<br>	 " );
                                        //select sum(cant) as total_exis from movimientos_entradas where clave='"+clave_jv+"' and lote='"+lote_jv+"' and caducidad='"+cad_jv+"' and origen='"+origen_jv+"';

                                        while (rset_mod2.next()) {
                                %>
                                <tr height="20">
                                    <td class="negritas" align="center"><%=rset_mod2.getString("folio")%>
                                    </td>
                                    <td class="negritas"><%=rset_mod2.getString("cant_anterior")%>
                                    </td>
                                    <td class="negritas" align="center"><%=rset_mod2.getString("cant_mov")%>
                                    </td>
                                    <td class="negritas" align="center"><%=rset_mod2.getString("cant_actual")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("status")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("obser")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("origen")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("usuario")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("fecha")%>
                                    </td>
                                    <td align="center" class="negritas"><%=rset_mod2.getString("hora")%>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td width="165" class="style5"><%=sum_mov_ent%>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style5"><%=sum_total_exis%>
                        </td>
                        <td class="style5">&nbsp;</td>
                        <td class="style5">&nbsp;</td>
                        <td>&nbsp;</td>
