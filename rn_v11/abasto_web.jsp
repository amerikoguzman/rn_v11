...
%>
<script>
    self.location = 'csv_abasto.jsp?archivo=c:/abastos_web/abasto_<%=(folio+"_"+df.format(new java.util.Date()))%>/<%=nom_abasto%>&token=<%=nom_abasto%>&usuario=<%=user%>&folio=<%=folio%>';
</script>
<%
...
<div style="width:800px; margin:auto; font-family:Verdana, Geneva, sans-serif; font-size:14px; background-color:#FFF; padding:15px">
    ...
    <form id="form1" name="form1" method="post" action="abasto_web.jsp">
        Ingrese el Folio:
