        ...
        <table width="91%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr>
                <td width="165" valign="top" bgcolor="#FFFFFF"><table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation">
                    ...
                    <p><a href="ver_receta.jsp?uni=<%=unidad2_jv%>&juris=<%=no_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&nombre=&edad=&folio=&cause=&clave1=&descrip1=&present1=&indica1=&sol1=&sur1=&foliore=&nomed=&cedu=&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=&id_med=&day5=&carnet=&mes5=&aa5='" class="style1">VER RECETA FARMACIA </a></p>
                    <p><a href="receta_col_checar.jsp?uni=<%=unidad2_jv%>&juris=<%=no_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&nombre=&edad=&folio=&cause=&clave1=&descrip1=&present1=&indica1=&sol1=&sur1=&foliore=&nomed=&cedu=&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=&id_med=&day5=&carnet=&mes5=&aa5=&servicio=&encarser=" class="style1">VER RECETA COLECTIVA </a>      </p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><div align="left">
                                                                    <select name="select_receta" class="style13" onchange="cerrar2()">
                                                                        ...
                                                                        <option value="Receta por Farmacia Fecha Automatica">1) Receta por Farmacia Fecha Autom&aacute;tica</option>
                                                                        <option value="Receta por Farmacia Fecha Manual">2) Receta por Farmacia Fecha Manual</option>
                                                                        <option value="Receta Colectiva Fecha Automatica">3) Receta Colectiva Fecha Automatica</option>
                                                                        <option value="Receta Colectiva Fecha Manual">4) Receta Colectiva Fecha Manual</option>

                                                                        <option value="Receta por Surtir Farmacia">5) Pendiente por Surtir Farmacia</option>
                                                                        <option value="Receta por Surtir Colectiva">6) Pendiente por Surtir Colectiva</option>
