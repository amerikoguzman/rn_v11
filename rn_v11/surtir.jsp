...
<%
/* ----------------------------------------------------------------------------------------------------
Nombre de JSP: surtir.jsp
Función      : Archivo puente para recibir los valores de la receta anterior (PS), direcciona a surtir_ins.jsp
               si se quiere surtir la receta, si no, regresa a receta_por_surtir.jsp
 ---------------------------------------------------------------------------------------------------- */
 // variables de entorno
String cb_jv="",nombre_jv="",edad_jv="",folio_jv="",cause_jv="",foliore_jv="",foliore2_jv="",radiopro_jv="",radiosur_jv="",date_jv="",reloj_jv="",encar_jv="",juris_jv="",clave_jv="",eliminar_jv="",usu_jv="",equipo_jv="",integrantes_jv="",recibe_id_jv="",lotes_jv="",cadus_jv="",fechanew="",afiliado_jv="",fuente="";
int tipo_rec=0;
//String eliminar_jv="";
