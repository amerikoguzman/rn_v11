...
// fin proceso Checar Existencias
	...
	*/				
	...
	// tabla modificacion
	stmt1.execute("insert into modificacion values ('"+clave_jv+"','"+descrip_jv+"','"+rset_001.getString("lote")+"','"+rset_001.getString("caducidad")+"','"+exist_ant+"','"+origen_jv+"','"+ap2_jv+"','"+exist_new+"','"+df.format(new java.util.Date())+"','"+am22_jv+"','ENTRADA AJUSTE MANUAL','"+razon+"',current_timestamp,'*','-','3','-','1','"+exist_new+"',0)");	
	// fin tabla
	...
	//   stmt1.execute("insert into modificacion values ('"+clave_jv+"','"+descrip_jv+"','-','-','"+exist_jv+"','"+origen_jv+"','"+ap2_jv+"','"+total+"','"+fechanew+"','"+am22_jv+"','AJUSTE MANUAL','',current_timestamp,'-','-','-','-','-','-',0)");	   
		 ...
		 // se ingresa el registro a inventario_uni
	  	  stmt01.execute("insert into inventario_uni values ('"+clave_jv+"','"+descrip_jv+"','"+lote_jv+"','"+cad_jv+"','"+ap2_jv+"','1','"+ap2_jv+"','"+ap2_jv+"','0','"+origen_jv+"','-','2','"+df.format(new java.util.Date())+"','"+hora_com+"',0)");
        // fin ingreso
		// se ingresa a movimientos_entradas
		 stmt1.execute("insert into movimientos_entradas values ('"+clave_jv+"','"+descrip_jv+"','"+lote_jv+"','"+cad_jv+"','"+ap2_jv+"','1','"+ap2_jv+"','"+origen_jv+"','A','"+df.format(new java.util.Date())+"','"+hora_com+"','2')");
		// fin ingreso 
	      
	  	   stmt1.execute("insert into modificacion values ('"+clave_jv+"','"+descrip_jv+"','"+lote_jv+"','"+cad_jv+"','0','"+origen_jv+"','"+ap2_jv+"','"+ap2_jv+"','"+df.format(new java.util.Date())+"','"+am22_jv+"','AJUSTE MANUAL','"+razon+"',current_timestamp,'*','-','3','-','1','"+ap2_jv+"',0)");
