...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,lote,caducidad,sum(cant_sur),present from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+origen_jv+"' and tipo_receta='rf' and cant_sur!=0 group by (clave),lote,caducidad order by clave asc; ");
	}
