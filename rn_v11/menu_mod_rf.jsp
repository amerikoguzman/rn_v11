    ...
    <td width="650"><form id="form" name="form" method="post" action="menu_mod_rf.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="elim_datos.jsp?usuario=<%=am22_jv%>">ELIMINAR FOLIO DE LA RECETA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="modi_datos.jsp?usuario=<%=am22_jv%>">MODIFICAR DATOS DE LA RECETA (ENCABEZADO)</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="3" class="style5"><label><a href="modi2_receta.jsp?uni=&juris=&nombre=&edad=&folio=&foliore=&nomed=&day5=&cedu=&ban=1&aa5=&mes5=<%=am22_jv%>">REINTEGRAR INSUMO AL INVENTARIO (ERROR DE CAPTURA)</a> </label></td>
          </tr>
        <tr>
          <td height="20">&nbsp;</td>
