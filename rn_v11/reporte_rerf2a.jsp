...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select fecha_re,folio_re,nombre_medi,nombre_pac,clave,descrip,lote,caducidad,cant_sol,cant_sur,  ampuleo from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and tipo_receta='rf' and cant_sur!=0  order by (fecha_re),folio_re asc");
	}
...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_rerf2a.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
...
rset_2=stmt__002.executeQuery("select count(folio_re) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and tipo_receta='rf' group by folio_re");
			while(rset_2.next()) 
                  {
				  folio_re2++;
