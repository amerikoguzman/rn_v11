...
------------------------------------------------------------------------------------------------------------------------*/
String cb_jv="",nombre_jv="",edad_jv="",folio_jv="",cause_jv="",foliore_jv="",foliore2_jv="",radiopro_jv="",radiosur_jv="",date_jv="",reloj_jv="",encar_jv="",juris_jv="",clave_jv="",eliminar_jv="",usu_jv="",equipo_jv="",integrantes_jv="",recibe_id_jv="",t1_jv="",t2_jv="",t3_jv="",programa_jv="",lotes_jv="",cadus_jv="",id_inv="";
//String eliminar_jv="";
...
String cantsur="",clavesur="",partidasur="",cantinv="",descripsur="",carnet_jv="",fechanew="",folio_re_jv="",cant_ant="";
...
stmt1 = conn_001.createStatement();
	...
	// fin de proceso -----------------------------------------------------------------				
		if(sol1_jv.equals(sur1_jv))
		{
			...
			stmt1.execute("insert into movimientos_salidas values ('"+clave1_jv+"','"+descrip1_jv+"','"+lotes_jv+"','"+cadus_jv+"','"+cant_sur_neg+"','1','"+cant_sur_neg+"','"+part_jv+"','-','"+date3+"','"+hora_com+"','10')"); 
			// fin agregar
			...
			while (rset_re.next())
			{
			 ...
			 // se agrega info a la tabla modificacion
				      stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','"+lotes_jv+"','"+cadus_jv+"','"+cant_ant+"','"+part_jv+"','"+sur1_jv+"','"+var_exist+"','"+date3+"','"+encar_jv+"','ELIMINACION DE INSUMO','REINTEGRACION DE SALIDA DE INSUMO AL INVENTARIO',current_timestamp,'"+foliore_jv+"','-','10','-','"+present1_jv+"','"+var_exist+"',0)");						 
					 // fin tabla modi 	
