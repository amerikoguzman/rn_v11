...
int x1=0,  ban=0,afi=0, ban_cur=0, cont=0;
...

{
					...
					if((reporte_jv.equals("rc")) && (!(org_jv.equals("AMBOS"))))
					{
						...
						rset_200 = stmt1.executeQuery("select partida from receta_colectiva where partida='"+org_jv+"' group by partida ");
				...
				self.location='reporte_recol2.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					...
					%>
                    <script>
					alert("NO EXISTEN REGISTROS CON LA INFORMACIÓN PROPORCIONADA");
					</script>
                    <%
					}else{
					
					rset_200 = stmt1.executeQuery("select partida from receta_colectiva group by partida ");
					...
					%>
					<script>
				self.location='reporte_recol2a.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					</script>
					...
					%>
                    <script>
					alert("NO HAY REGISTROS DE LA INFORMACIÓN PROPORCIONADA");
					</script>
                    <%
					}
...
<table width="103%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr bgcolor="#D5EDB3">
    <td colspan="2" bgcolor="#FFFFFF">&nbsp;
        <img src="imagenes/nay_ima1.jpg" width="163" height="82" /></td>
            ...
            <td width="453" class="bodyText"><table width="652" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="37" colspan="4" bgcolor="#FFFFFF"><div align="center">
                      <p align="center"><img src="imagenes/ima_main.jpg" width="516" height="93" /></p>
                  </div></td>
                </tr>
                <tr>
		...
		String fechaa2_jv="";
          ...
          <label></label>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  ...
                  <td width="194" nowrap bgcolor="#FFFFFF"><img src="imagenes/px.gif" width="1" height="1" alt="" border="0" /><img src="imagenes/matc2.jpg"  /></td>
                </tr>
                <tr>
                  <td colspan="4">&nbsp;</td>
                </tr>
