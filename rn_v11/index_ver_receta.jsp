...
<table width="666" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="650"><form id="form" name="form" method="post" action="index_ver_receta.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1"><div align="center">Men&uacute; Ver Recetas</div></td>
          <td height="49" bgcolor="#FFFFFF" class="logo style1"><img src="imagenes/ssn.jpg" width="162" height="78" /></td>
        </tr>
        <tr>
          <td height="14" colspan="4" bgcolor="#D51046"><a href="index.jsp" class="Estilo10 Estilo8">Regresar a Menú </a></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="ver_receta.jsp?uni=<%=unidad2_jv%>&juris=<%=no_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&nombre=&edad=&folio=&cause=&clave1=&descrip1=&present1=&indica1=&sol1=&sur1=&foliore=&nomed=&cedu=&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=&id_med=&day5=&carnet=&mes5=&aa5='">RECETA POR FARMACIA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="dispensado_col.jsp">RECETA COLECTIVA</a> </label></td>
          <td>&nbsp;</td>
        </tr>
