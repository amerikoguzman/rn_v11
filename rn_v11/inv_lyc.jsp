...
<table width="850" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a name="Arriba" id="Arriba"></a>&nbsp;Inventario Unidad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
          <td height="33">&nbsp;</td>
          <td class="bodyText" style="text-align:right">Pr&oacute;ximos a Caducar en <input type="text" name="caduca_mes" size="1" value = "<%if (cad_mes==100){}else{out.print(cad_mes);}%>" /> meses &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="lote" id="lote" <%if (lote.equals("on")){out.print("checked='checked'");}%>  />
        ...
        <tr>
          ...
          <td><div <%if (!lote.equals("on")){out.print("style='visibility:hidden'");}%>><!--a href="pass_elote.jsp?id=<%//=id%>" target="_blank" ><img src="imagenes/edit.png" width="25" height="25" /></a--></div></td>
        </tr>
		<%
		cant_ps_jv="1";
		}
...
<area shape="rect" coords="0,3,38,29" href="repor_inventario.jsp?caduca_mes=<%=caduca_mes%>&lote=<%=lote%>&Submit=<%=but%>" />
</map>
