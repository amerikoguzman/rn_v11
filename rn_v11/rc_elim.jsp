...
<form name="form" method="post" action="rc_elim.jsp?usuario=<%=usuario%>&ban=<%=tipo_rec%>">
  ...
  <tr>
    <td width="725" height="156"><table width="860" border="0" align="center" cellpadding="2">
      <tr>
        ...
        RECETA COLECTIVA<br />ELIMINAR FOLIO</span></div></td>
      ...
      <table width="914" height="61" border="0" align="center" cellpadding="2">
        <tr>
		 ...
		 %>
          ...
          <td width="250" class="style2">FECHA:<input name="txtf_date" type="text" class="Estilo5" onKeyPress="return handleEnter(this, event)" value="<%=date_jv%>" size="10"   /> HORA:
                <input name="reloj" type="text" value="<%=hora_jv%>"  class="Estilo5" onKeyPress="return handleEnter(this, event)" size="10" readonly >         
            </td>
		...
		<table width="939" border="0" align="center" >
            <tr>
              ...
              <td width="226" class="style11"><span class="style2">
                <input type="text" name="txtf_servicio" class="Estilo5" size="30" value="<%=servicio_jv%>" readonly />
              </span></td>
   ...
   while(rset.next()) 
    ...
    <tr>
      ...
      <tr>
        <td height="40" colspan="3" class="style4"><!--input name="Submit" type="submit" class="subHeader" value="Eliminar Folio" onClick="return verifica_ACT(document.forms.form);"/--><a onClick="return confirm('Seguro que desea eliminarlo?')" href="elim_rc.jsp?usuario=<%=usuario%>&folio=<%=foliore_jv%>&url=<%=request.getRequestURL() %>">Eliminar Folio</a></td>
  </tr>  
