...
if(but.equals("Actualizar Datos"))
     {
	 	 ...
	 	 String f_mod=request.getParameter("txtf_t1");
	 	 ResultSet rset_date = stmt_date.executeQuery("SELECT STR_TO_DATE('"+f_mod+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%m/%d/%Y')
         while(rset_date.next())
		 {
             fecha_mod= rset_date.getString("STR_TO_DATE('"+f_mod+"', '%d/%m/%Y')");//STR_TO_DATE('"+date_jv+"', '%m/%d/%Y')
		 }
		 //out.print(f_mod+"+++"+fecha_mod);
      ...
      <table width="877" height="59" border="0" align="center" cellpadding="2">
        <tr>
          <td width="440" height="55" class="style2">
            Ingrese No. Folio:
          <input name="txtf_foliore" type="text" class="style13" onKeyPress="return handleEnter(this, event)"  value="<%=foliore_jv%>" size="15" />
          ...
          <td width="167"><table width="167" height="0%" border="0" cellpadding="2">
            <tr>
              <td width="225" height="100%" class="style2">HORA:
                <input name="reloj" type="text" class="style13" onKeyPress="return handleEnter(this, event)" value="<%=hora_rec%>" size="15" readonly ></td>
            </tr>
          </table></td>
          <td width="250" align="center" class="style2">
            FECHA:
                  <input name="txtf_t1" type="text" class="style13" id='txtf_t1' onKeyPress="return handleEnter(this, event)"  value="<%=t1_jv%>" size="10" readonly/> &nbsp;&nbsp;                 <img src="imagenes/cal.jpg" width="26" height="27" border="0" onClick="scwShow(scwID('txtf_t1'), event)" />
                  &nbsp;&nbsp;</td>
        </tr>
    </table>    </td>
  </tr>
        ...
        <tr>
          <td height="41" colspan="3" class="style4"><table width="874" border="0" align="center" cellpadding="2">
            <tr>
              ...
              <input name="txtf_unidadmed" type="text" class="style13" onKeyPress="return handleEnter(this, event)"  value="<%=nom_unidad%>" size="55" readonly colspan="3"/></td>
              <td width="175"><table width="170" border="0" align="left" cellpadding="2">
                <tr>
                  <td width="162" align="center"><div align="center" class="style2">JURISDICCION&nbsp;&nbsp;<input name="txtf_njuris" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=no_jur%>" size="1" readonly/>
                  </div></td>
                </tr>
              </table></td>
            </tr>
