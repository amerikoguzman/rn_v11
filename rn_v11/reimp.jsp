...
<% 
/* ----------------------------------------------------------------------------------------------------
Nombre de JSP: reimp.jsp
Función      : Realiza una consulta de la Receta y permite reimprimir el ticket
   ---------------------------------------------------------------------------------------------------- */
...
String hora_ini_jv="";
String lugar_jv="";
String cb_jv="",nombre_jv="",edad_jv="",folio_jv="",cause_jv="",foliore_jv="",foliore2_jv="",foliore3_jv="",radiopro_jv="",radiosur_jv="",date_jv="",reloj_jv="",encar_jv="",juris_jv="",clave_jv="",eliminar_jv="",usu_jv="",equipo_jv="",integrantes_jv="",recibe_id_jv="",cv_dgo_jv="",cv_uni_jv="",cv_mpio_jv="",id_med_jv="",part_jv="",layout="",cv_finan_jv="",financiamiento1="",precio_jv="",monto_jv="",exi_jv="",lote2_jv="",cant_jv="",date2_jv="",precio="",carnet_jv="",mensaje="";
String but="r";
String but2="r";
String nom_unidad="",no_jur="";
int cont1=0,cont2=0,cont3=0,cv_med2=0,cv_med3=0,pos=0,posf=0,x1=0,sur2=0,sol2=0,cant2_jv=0,resto_jv=0, ban_exis=0;
...
String encontrado="",oring="",sexo_jv="";
...
// Proceso Por Folio- Muestra los datos de una receta
if(but.equals("Por Folio"))
  {
	 ...
	 rset1= stmt.executeQuery("select * from receta where folio_re='"+foliore_jv+"' ");
	  ...
	  while(rset1.next())
					 ...
					 hora_ini_jv=rset1.getString("hora");
					 ban_exis=1;
					 }
			if(ban_exis==0)
			  {
				...
				%>
                <script>
				alert("Folio Inexistente, Intente otra vez");
				</script>
                <%	 
			  }		 
}
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='ticket_rei.jsp?folio=<%=foliore2_jv%>&receta5=RF&encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>&sexo=<%=sexo_jv%>';
...
<body onLoad="SetCur();">
<form name="form" method="post" action="reimp.jsp?uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&part=<%=part_jv%>&carnet=<%=carnet_jv%>&sexo=<%=sexo_jv%>">
<!--a href="index.jsp" class="style2">REGRESAR A MENÚ</a-->
<table width="817" height="529" border="3" align="center" cellpadding="2">
  <tr>
    <td width="725" height="114"><table width="758" border="0" align="center" cellpadding="2">
      <tr>
        ...
        <td width="339"><div align="center" class="style7">SERVICIO DE SALUD DE NAYARIT<br />
        ...
        <td width="225"><img src="imagenes/ssn.jpg" width="219" height="89" /><!--input name="Submit"  type="reset" class="bodyText" value="Borrar Datos" /--></td>
      </tr>
    </table>
      <table width="763" height="45" border="0" align="center" cellpadding="2">
        <tr>
          <td width="424" height="41">
            <table width="428" height="0%" border="0" cellpadding="2">
              <tr>
                <td class="style2">Ingrese No. Folio:<input name="txtf_foliore" type="text" class="style13"  value="<%=foliore_jv%>" size="15" /><input name="Submit" type="submit" class="subHeader" value="Por Folio"/></td>
              </tr>
          </table>          </td>
          <td width="167"><table width="167" height="0%" border="0" cellpadding="2">
            <tr>
              <td width="225" height="100%" class="style2">HORA:
                <input name="reloj" type="text" class="style13" onKeyPress="return handleEnter(this, event)" value="<%=hora_ini_jv%>" size="15" readonly ></td>
            </tr>
          </table>            
          </td>
          <td width="152" align="center" class="style2">
            FECHA:
            <input name="txtf_t1" class="style13" type="text" onKeyPress="return handleEnter(this, event)" value="<%=t1_jv%>" size="10" readonly/>
        ...
        <tr>
          <td height="62" colspan="3" class="style4"><table width="753" border="0" align="center" cellpadding="2">
            <tr>
              <td width="723" height="52" class="style2">NOMBRE DEL PACIENTE:
                <label> </label>
                <span class="style5">
                <label> </label>
                <input name="txtf_paciente" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=nombre_jv%>" size="50" readonly="readonly"/>
                </span>
                <label><span class="style2">
                
                Sexo:
                <input name="txtf_sexo" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=sexo_jv%>" size="5" readonly="readonly"/>
                EDAD:
                <input name="txtf_edad" type="text" class="style13"  onkeypress="return handleEnter(this, event)" value="<%=edad_jv%>" size="5" readonly="readonly"/>
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO PATERNO </span><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO MATERNO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label></td>
        ...
        <tr>
          <td height="82" colspan="3" class="style4"><table width="733" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <td class="style11"><input name="txtf_foliosp" type="text" class="style13" onKeyPress="return handleEnter(this, event)" value="<%=folio_jv%>" size="50" readonly="readonly"/></td>
            </tr>
          ...
          <td height="38" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            <tr>
              ...
              NOMBRE M&Eacute;DICO:
                <input name="txtf_nomed" type="text" class="style13"  onKeyPress="return handleEnter(this, event)" value="<%=nomed_jv%>" size="35" readonly="readonly" />
              <span class="style2">C&Eacute;DULA: 
              <input name="txtf_cedu" type="text" class="style13" id="a"  onKeyPress="return handleEnter(this, event)" value="<%=cedu_jv%>" size="10" readonly="readonly"/>
              CAUSES:
              <input name="txtf_cause" type="text" class="style13" onKeyPress="return handleEnter(this, event)" value="<%=cause_jv%>" size="8" readonly="readonly" />
              </span></td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td height="129" colspan="3" class="style4"><table width="805" border="0" align="center" cellpadding="2">
            <tr>
              ...
              <td class="style11" align="center"><span class="style2">LOTE</span></td>
              <td class="style11" align="center"><span class="style2">CADUCIDAD</span></td>
  ...
  ResultSet rset__001=stmt__001.executeQuery("select clave,descrip,lote,caducidad,cant_sol,cant_sur,surtido,id from receta where folio_re='"+foliore_jv+"' and cant_sur!=0");
  ...
  %>
            <tr>
              ...
              <td class="style11" align="center"><%=rset__001.getString("lote")%></td>
              <td class="style11" align="center"><%=rset__001.getString("caducidad")%></td>
	  ...
	  %>
            ...
            <tr>
              ...
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11"><input name="Submit" type="submit" class="subHeader" value="Imprimir" onClick="return verifica_PSI(document.forms.form);" />
              &nbsp;<span class="style2">Cerrar </span> <button name="boton" type="button" class="style7" onClick="CloseWin()" /><img src="imagenes/borr.jpg" /></button></td>
            </tr>
          </table></td>
  </tr>
        </tr>
