...
String partida_o1_jv="",partida_o2_jv="",sumatotal="",cant_o1_jv="",cant_o2_jv="",id_send="",nuevo_folio="",act_folio="",id_rec="";
int cant2_o1_jv=0,cant2_o2_jv=0,mtotalot=0,mtotalotsur=0,resto22_jv=0,mtotalotsur2=0,c_s=0,ban_csol=0,ban_csur=0,cont4=0,cant_x_sutir_neg=0;
String but="r";
String but2="r";
...
if(but.equals("Eliminar Folio"))
     {
		 ...
		 rset2= stmt2.executeQuery("select folio_re from receta where folio_re='"+act_folio+"' ");
	  while(rset2.next())
	  {
	  	cont4++;
		break;
	  ...
	  while(rset.next())
	  {
		 ...
		 if(resto==0)
		 {
		   ...
		   {cant_x_sutir=resto;
		    ...
		    if(cant_x_sutir<=exis_restantes)
			{
				...
				stmt1.execute("insert into movimientos_salidas values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+cant_por_surtir+"','1','"+cant_por_surtir+"','"+rset.getString("origen")+"','-','"+df.format(new java.util.Date())+"','"+reloj_jv+"','5')"); 
		...
		stmt1.execute("insert into receta values ('"+foliore_jv+"','"+fechanew+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','"+nombre_jv+"','"+edad_jv+"','"+folio_jv+"','"+programa_jv+"','-','"+cedu_jv+"','"+nomed_jv+"','"+cause_jv+"','"+clave1_jv+"','"+descrip1_jv+"','"+cant_por_surtir+"','"+cant_por_surtir+"','"+status_surt+"','"+usuarios+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+rset.getString("origen")+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RF','-','-','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+carnet_jv+"','-','"+fecha_mod+"','A','"+sexo_jv+"','"+indi+"','-','-','-','-','-','"+corte+"','"+ampuleo+"',0)");	
			...
			else
			{
				...
				stmt1.execute("insert into movimientos_salidas values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+exis_restantes+"','1','"+exis_restantes+"','"+rset.getString("origen")+"','-','"+df.format(new java.util.Date())+"','"+reloj_jv+"','5')"); 
				// fin insert a movimientos_salida
   ...
   while(rset.next())
	  {
		 ...
		 {
		  //se hace un insert a movimientos_salida
				stmt1.execute("insert into movimientos_salidas values ('"+rset.getString("clave")+"','"+rset.getString("descrip")+"','"+rset.getString("lote")+"','"+rset.getString("caducidad")+"','"+exis_may+"','1','"+exis_may+"','"+rset.getString("origen")+"','-','"+df.format(new java.util.Date())+"','"+reloj_jv+"','5')"); 
				// fin insert a movimientos_salida
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO PATERNO </span><span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO MATERNO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label></td>
  ...
  <td align="center"><!--input name="Submit" type="submit" class="subHeader" value="Eliminar Folio" onClick="return verifica_ACT(document.forms.form);"/--><a onClick="return confirm('Seguro que desea eliminarlo?')" href="elim_folio.jsp?usuario=<%=usuarios%>&folio=<%=foliore_jv%>&url=<%=request.getRequestURL() %>">Eliminar Folio</a></td>      
  </tr>
</table>
<%
