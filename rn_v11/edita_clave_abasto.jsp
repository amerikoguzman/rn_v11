...
<%
    ...
    while (rset.next()) {
        ...
        stmt2.execute("insert into modificacion_abastos values('" + folio + "', '" + clave + "', '" + descrip + "', '" + lote_up + "', '" + fecha_up + "', '" + cant_up + "','" + cantent_up + "', '" + ori_up + "', '" + df.format(new java.util.Date()) + "', '" + df2.format(new java.util.Date()) + "', 'MODIFICACION', '0','" + lote + "','" + cad + "','" + cantent + "','" + ori + "')");
