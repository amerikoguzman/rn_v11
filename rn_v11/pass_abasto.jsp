...
//-----FIN PARAMETROS -----------
    ...
    if (but.equals("Validar")) {
        ...
        session.setAttribute("usuario", am_jv);
        session.setAttribute("valida", "valida");
...
<script>
    ...
    self.location = 'selec_abasto.jsp'
</script>
<%
} else {
%>
...
<table width="666" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
    <tr>
        ...
        <td width="650">
            <form id="form" name="form" method="get" action="pass_abasto.jsp">
                <table width="650" height="323" border="0" align="center" cellpadding="2">
                    <tr>
                        ...
                        <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1">
                            <div align="center">Validaci&oacute;n de Usuario<br/>
                                CARGA DE ABASTOS
                            </div>
                        </td>
                    ...
                    <tr>
                        <td height="14" colspan="4" bgcolor="#EC3237"><a href="index.jsp" class="Estilo10">Regresar a
                            Menú </a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="style5"><input name="txtf_usu" type="text" id="txtf_usu"
                                                  onKeyPress="return handleEnter(this, event)" size="15"/></td>
                        <td class="style5">&nbsp;</td>
                    </tr>
                    <tr>
                        <td height="20">
                        ...
                        <td class="style5"><input name="txtf_pass" type="password" id="txtf_pass"
                    ...
                    <tr>
                        <td height="20" colspan="4" align="center"><img src="imagenes/ima_main.jpg" width="471"
                                                                        height="72"/></td>
                    </tr>
                </table>
            </form>
